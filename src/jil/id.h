...
enum {
  ...
  // Preferences menu
  // Global (wxID_PREFERENCES)
  ID_MENU_PREFS_SYNTAX_CURRENT,  // Current syntax
  ID_MENU_PREFS_SYNTAX_BEGIN,
  ID_MENU_PREFS_SYNTAX_END = ID_MENU_PREFS_SYNTAX_BEGIN + kMaxFileTypes,
