...
enum {
  ...
  // Find panel
  ID_FP_LOCATION_LABEL,
  ID_FP_LINE_RANGE_TEXTCTRL,
  ID_FP_FILTERS_TEXTCTRL,
  ID_FP_FOLDERS_TEXTCTRL,
  ID_FP_FIND_COMBOBOX,
  ID_FP_REPLACE_COMBOBOX,
  ...
  // Find panel - Location menu
  ID_FP_MENU_CURRENT_PAGE,
  ID_FP_MENU_ALL_PAGES,
  ID_FP_MENU_FOLDERS,
  ID_FP_MENU_ADD_LINE_RANGE,
  ID_FP_MENU_ADD_FILTERS,
